...
export const PLACEMENT_QUESTIONS = Object.freeze([
  ...
  },
  {
    ...
    difficulty: 2,
    skill: "Revision",
    prompt: "If an ayah feels uncertain, what is the best next step?",
    options: [
      { id: "review", label: "Return to it with short, regular review" },
      { id: "avoid", label: "Avoid it forever" },
      { id: "guess", label: "Guess and never check" },
      { id: "replace", label: "Replace it with an unrelated ayah" },
    ],
  ...
  },
  {
    ...
    difficulty: 3,
    skill: "Surah themes",
    prompt: "Which surah repeatedly calls us to notice Allah's favours?",
    options: [
  ...
  },
  {
    ...
    difficulty: 3,
    skill: "Study habits",
    prompt: "What is a sustainable way to study a longer surah?",
    options: [
  ...
  },
  {
    ...
    prompt: "What should you do after noticing a recurring recitation mistake?",
    options: [
